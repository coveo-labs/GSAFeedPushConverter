...

{
    public class SimpleLogger
    {
        ...
        public SimpleLogger(Configuration config, bool append = false)
        {
            s_Config = config;
            SetupLogger(append);
        }

        private void SetupLogger(bool append = false)
        {
            DatetimeFormat = "yyyy-MM-dd HH:mm:ss.fff";

            Directory.CreateDirectory("logs");
            Filename = "logs/" + s_Config.ListeningHost + "_" + s_Config.ListeningPort + "_" + DateTime.Now.ToString("yyyy-MM-dd") + ".log";
        ...
        {
            // Rotate logs if necessary before writing log
            RotateLogs();
        ...
        {
            // Before writing a log, see if the log file should be rotated
